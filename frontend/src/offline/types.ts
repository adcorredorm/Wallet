...
export interface LocalTransaction extends Transaction {
  ...
  base_rate?: number   // Units of primaryCurrency per 1 unit of account.currency at capture time
}
...
export interface LocalTransfer extends Transfer {
  ...
  base_rate?: number   // Units of primaryCurrency per 1 unit of source_account.currency at capture time
}
